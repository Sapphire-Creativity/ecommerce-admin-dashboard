...
export default function AuthPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-100 to-orange-50 px-4 py-8 overflow-hidden">
      {/*  */}
      <div className="absolute inset-0">
        <img
          src={dashboardImage}
          alt="Dashboard Preview"
          className="w-full h-full object-cover opacity-30  animate-bg-grow"
        />

        {/* <div className="absolute inset-0 bg-gradient-to-br from-blue-50/70 to-purple-50/70" /> */}
      </div>

      {/* Auth content */}

      <div className="relative z-10">
        <div className="grid md:grid-cols-2 bg-white shadow-2xl rounded-2xl overflow-hidden w-full max-w-[25rem] md:max-w-[50rem]">
          {/* Left Column - Enhanced */}
          <div className="hidden md:flex flex-col items-center justify-center p-10 bg-gradient-to-br from-[#e76f00] to-[#cc5500] text-white text-center relative overflow-hidden">
            {/* Decorative elements */}
          ...
          {/* Right Column (Form) */}
          <div className="py-4 md:py-6 px-4 relative min-h-[450px] flex items-center">
